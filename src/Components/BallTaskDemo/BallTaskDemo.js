        ...
        <div className="ballTaskDemo-container">
            ...
            >
                <div>
                    ...
                    Dragging the sliders above, and you will find the latent space learned by the model is 
            ...
            >
                <div>
                    ...
                    The learned three dimensions of the latent space are not linear to the three axes of a Cartesian coorinate system.
                 </div>
            </ImageSlider>
            <ImageSlider 
            ...
            >
                <div>
                    ...
                    the Beta-VAE baseline can only learn the distribution of images but cannot predict the next frame.
                    Similar to Demo 2, the learned latent space has no interpretability.
                </div>
            </ImageSlider>
        </div>
    );
